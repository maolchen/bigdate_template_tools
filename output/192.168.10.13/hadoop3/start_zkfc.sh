...
# ============================================================
log_info "步骤6: 使用 systemctl 启动 ZKFC..."
...
# ============================================================
# 步骤8: 验证 NameNode HA 状态
# ============================================================
log_info "步骤8: 验证 NameNode HA 状态..."
...
echo ""
echo "后续步骤:"
echo "  启动 DataNode: bash start_datanode.sh"

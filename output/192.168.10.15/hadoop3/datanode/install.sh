#!/bin/bash
# Hadoop 3 DataNode 数据目录准备脚本
# 使用方法: bash install.sh
# 说明: Hadoop是统一安装的，此脚本仅准备DataNode数据目录
...
# ============================================================
echo "============================================"
echo "Hadoop 3 DataNode 数据目录准备脚本"
echo "============================================"
echo "主机名: $(hostname)"
...
run_as_root chmod 750 "${DATANODE_DATA_DIR}"
log_info "数据目录创建完成: ${DATANODE_DATA_DIR}"

# ============================================================
# 步骤3: 创建短路读取Socket目录
# ============================================================
log_info "步骤3: 创建短路读取Socket目录..."
...
log_info "Socket目录创建完成: ${SOCKETS_DIR}/dn"

# ============================================================
# 步骤4: 创建日志和PID目录
# ============================================================
log_info "步骤4: 创建日志和PID目录..."

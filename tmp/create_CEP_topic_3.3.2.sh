...
#1.mkt-threshold-cep
#bin/kafka-topics.sh --bootstrap-server realtime-kafka01:9092 --create --topic mkt-threshold-cep --partitions=5 --replication-factor 2;
bin/kafka-run-class.sh kafka.tools.UpdateOffsetsInZK earliest mkt-threshold-cep.properties mkt-threshold-cep;

#2.mkt-activity-cep
#bin/kafka-topics.sh --bootstrap-server realtime-kafka01:9092 --create --topic mkt-activity-cep --partitions=5 --replication-factor 2;
...
#4.tag_sink_r2p3
#bin/kafka-topics.sh --bootstrap-server realtime-kafka01:9092 --create --topic tag_sink_r2p3 --partitions=5 --replication-factor 2;
...
#6.mkt-postman-cep
#bin/kafka-topics.sh --bootstrap-server realtime-kafka01:9092 --create --topic mkt-postman-cep --partitions=5 --replication-factor 2;
...
#bin/kafka-topics.sh --bootstrap-server realtime-kafka01:9092 --create --topic mkt-statistics-cep --partitions=5 --replication-factor 2
